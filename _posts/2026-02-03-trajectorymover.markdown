...
---
We present a video-to-video editing method that moves an object’s trajectory while preserving its relative 3D motion, enabled by a large-scale synthetic paired video data generation pipeline for this task.
